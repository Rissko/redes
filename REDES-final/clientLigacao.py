...
def iniciaConexaoUDP(dest_ip, origem_name, endcallbtn, busy, console):
    global conexaoUdp
    global dest
    ...
    thread = threading.Thread(target=ouvirResposta, args=(conexaoUdp, endcallbtn, busy, console))
    thread.start()
...
def ouvirResposta(conexaoUdp, endcallbtn, busy, console):
...
def send_audio(dest, busy, console,endcallbtn):
    global input_stream
    global py_audio
